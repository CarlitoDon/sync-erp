#!/usr/bin/env python3
"""Final PDF - ALL 46 orders (26 ERP + 20 WhatsApp)."""
...
# ERP: (order#, name, lokasi, kirim, ambil, malam, total, dp, sisa, items, tipe)
erp = [
...
# WhatsApp: same structure with WA- prefix
wa = [
    ...
    ("WA-05", "Dzaky", "Seyegan", "26 Mar 26", "29 Mar 26", 3, 552000, 0, 552000, "Q160x3", "Paket (Lebaran)"),
    ("WA-06", "Fendy", "Banguntapan", "18 Mar 26", "25 Mar 26", 7, 642000, 0, 642000, "S100x2", "Paket (Lebaran)"),
    ("WA-07", "Fendy (Perpanjangan)", "Banguntapan", "25 Mar 26", "28 Mar 26", 3, 264000, 0, 264000, "S100x2", "Paket (Lebaran)"),
    ("WA-08", "Felis / Ella", "Jitar Dukuh", "17 Mar 26", "23 Mar 26", 6, 644000, 300000, 344000, "Q160x1, S100x1", "Paket (Lebaran)"),
    ("WA-09", "Lucky Enjang", "BMT BIF Tajem", "17 Mar 26", "18 Mar 26", 1, 93000, 40000, 53000, "S90x1", "Paket (Lebaran)"),
    ("WA-10", "Muji", "Jakal KM19", "24 Mar 26", "25 Mar 26", 1, 320000, 0, 320000, "D120x2(plain), S100x1, D120x2, Selimutx2", "Paket (Lebaran)"),
    ("WA-11", "Muji", "Jakal KM19", "25 Mar 26", "26 Mar 26", 1, 252000, 0, 252000, "D120x2(plain), S100x1, D120x2, Selimutx2", "Paket (Lebaran)"),
    ("WA-12", "Muji", "Jakal KM19", "26 Mar 26", "27 Mar 26", 1, 252000, 0, 252000, "D120x2(plain), S100x1, D120x2, Selimutx2", "Paket (Lebaran)"),
    ("WA-13", "Nisrina", "Kotagede", "19 Mar 26", "23 Mar 26", 4, 518000, 0, 518000, "Q160x2", "Paket (Lebaran)"),
    ("WA-14", "Nawang", "Klaci 3 Seyegan", "12 Apr 26", "13 Apr 26", 1, 60000, 20000, 40000, "D120x1", "Paket"),
    ("WA-15", "Nawang", "Klaci 3 Seyegan", "12 Apr 26", "14 Apr 26", 2, 95000, 30000, 65000, "S100x1", "Paket"),
    ("WA-16", "Feris", "Greenhills Sardonoharjo", "23 Mar 26", "25 Mar 26", 2, 685000, 0, 685000, "S100x1, D120x2, Q160x3", "Paket (Lebaran)"),
    ("WA-17", "Zami Fatih", "Seyegan", "6 Apr 26", "10 Apr 26", 4, 205000, 0, 205000, "D120x1", "Paket"),
    ("WA-18", "Jhon BT", "Sidikan UH V/546", "28 Mar 26", "30 Mar 26", 2, 183000, 75000, 108000, "Q160x1, Sprei S100x1", "Paket (Lebaran)"),
    ("WA-19", "Harmawan", "Swantari Terrace Villa", "11 Apr 26", "12 Apr 26", 1, 145000, 45000, 100000, "S90x3", "Paket"),
    ("WA-20", "Aryadi", "Banguntapan Bantul", "10 Apr 26", "12 Apr 26", 2, 420000, 126000, 294000, "D120x4", "Paket"),
]
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 4, 'Sync ERP + WhatsApp Business | 27 Mei 2026 | 46 Orders', 0, 1, 'C')
        self.ln(2)
    def footer(self):
        self.set_y(-12)
...
def gen():
    ...
    for l, v in [
        ('Total Customers', '71 (55 ERP + 16 WA)'),
        ('Total Rental Orders', f'{total} orders'),
        ('  Dari Sync ERP', f'{len(erp)} orders'),
        ('  Dari WhatsApp (baru)', f'{len(wa)} orders'),
    ...
    # NO INVOICE
    p.add_page()
    p.sec('CUSTOMER TANPA INVOICE (5)')
    p.set_font('Helvetica', '', 8)
    p.cell(0, 4, 'Customer ada di WhatsApp tapi invoice tidak bisa diakses:', 0, 1)
    p.ln(1)
    ...
    out = '/tmp/whatsapp_data/Laporan_Santi_Living_LENGKAP.pdf'
    p.output(out)
    return out
