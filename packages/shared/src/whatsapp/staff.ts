 ...
 *
 * Used to unconditionally protect internal chats:
 * 1. Inbound messages from these numbers/LIDs are completely ignored by Baileys
 *    (no chat history, no webhook, no AI response, no escalation).
 * 2. Numbers here are strictly forbidden from being added to whatsapp:allowed_phones.
 * 3. Outbound automated sales messages cannot be addressed to these numbers.
 */
 ...
 * Normalizes input:
 * - '081249182155' -> '6281249182155'
 * - '+62 812-4918-2155' -> '6281249182155'
 * - '6281249182155@s.whatsapp.net' -> '6281249182155'
 * - '75432611295262@lid' -> '75432611295262'
 */
export function isInternalStaff(identifier: string | null | undefined): boolean {
  ...
  // 2. Direct phone / normalized phone match
