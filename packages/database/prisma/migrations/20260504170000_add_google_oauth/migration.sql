-- AlterEnum
ALTER TYPE "AuthAuditAction"
ADD VALUE IF NOT EXISTS 'GOOGLE_OAUTH_LINKED';

ALTER TYPE "AuthAuditAction"
ADD VALUE IF NOT EXISTS 'GOOGLE_OAUTH_SUCCEEDED';

ALTER TYPE "AuthAuditAction"
ADD VALUE IF NOT EXISTS 'GOOGLE_OAUTH_FAILED';
