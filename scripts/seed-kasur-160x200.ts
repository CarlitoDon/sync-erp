...
async function main(): Promise<void> {
  console.log('--- Seeding Kasur 160x200 (6 Units) for Santi Living ---');
  ...
  if (!product) {
    product = await prisma.product.create({
      data: {
        ...
        sku,
        name: 'Kasur 160x200',
        price: new Prisma.Decimal(1000000), // Replacement / retail valuation
        averageCost: new Prisma.Decimal(700000), // Acquisition cost
