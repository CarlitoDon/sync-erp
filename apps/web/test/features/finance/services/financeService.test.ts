...
describe('financeService', () => {
  ...
  describe('Accounts', () => {
    it('should list accounts', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/finance/accounts', {
        params: {},
      });
  ...
  describe('Journals', () => {
    it('should list journals with date range', async () => {
      ...
      const result = await financeService.listJournals(
        '2023-01-01',
        '2023-01-31'
      );
    ...
    it('should create journal', async () => {
      const dto: CreateJournalEntryInput = {
        date: '2023-01-01',
        lines: [],
      };
      const mockData = { id: '1' };
  ...
  describe('Reports', () => {
    it('should get trial balance', async () => {
      ...
      const result =
        await financeService.getTrialBalance('2023-01-01');
