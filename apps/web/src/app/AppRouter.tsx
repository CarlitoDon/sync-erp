...
const Companies = lazy(
  () => import('@/features/company/pages/Companies')
);
const CreateCompany = lazy(
  () => import('@/features/company/pages/CreateCompany')
);
...
const TeamManagement = lazy(
  () => import('@/features/company/pages/TeamManagement')
);

// Procurement pages - lazy loaded
const Suppliers = lazy(
  () => import('@/features/procurement/pages/Suppliers')
);
const SupplierDetail = lazy(
  () => import('@/features/procurement/pages/SupplierDetail')
);
const PurchaseOrders = lazy(
  () => import('@/features/procurement/pages/PurchaseOrders')
);
const PurchaseOrderDetail = lazy(
  () => import('@/features/procurement/pages/PurchaseOrderDetail')
);

// Sales pages - lazy loaded
const Customers = lazy(
  () => import('@/features/sales/pages/Customers')
);
const CustomerDetail = lazy(
  () => import('@/features/sales/pages/CustomerDetail')
);
const SalesOrders = lazy(
  () => import('@/features/sales/pages/SalesOrders')
);
const SalesOrderDetail = lazy(
  () => import('@/features/sales/pages/SalesOrderDetail')
);
const Quotations = lazy(
  () => import('@/features/sales/pages/Quotations')
);
...
const GoodsReceipts = lazy(
  () => import('@/features/inventory/pages/GoodsReceipts')
);
const GoodsReceiptDetail = lazy(
  () => import('@/features/inventory/pages/GoodsReceiptDetail')
);
const Shipments = lazy(
  () => import('@/features/inventory/pages/Shipments')
);
...
const Finance = lazy(
  () => import('@/features/accounting/pages/Finance')
);
const Invoices = lazy(
  () => import('@/features/accounting/pages/Invoices')
);
const InvoiceDetail = lazy(
  () => import('@/features/accounting/pages/InvoiceDetail')
);
const AccountsPayable = lazy(
  () => import('@/features/accounting/pages/AccountsPayable')
);
const BillDetail = lazy(
  () => import('@/features/accounting/components/BillDetail')
);
const Payments = lazy(
  () => import('@/features/accounting/pages/Payments')
);
const PaymentDetail = lazy(
  () => import('@/features/accounting/pages/PaymentDetail')
);
const ExpenseList = lazy(
  () => import('@/features/accounting/pages/ExpenseList')
);
const ExpenseDetail = lazy(
  () => import('@/features/accounting/pages/ExpenseDetail')
);
...
const Observability = lazy(
  () => import('@/features/admin/pages/Observability')
);
