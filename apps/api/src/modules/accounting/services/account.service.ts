...
export class AccountService {
  ...
  async seedDefaultAccounts(companyId: string): Promise<Account[]> {
    const defaultAccounts = [
      ...
      // Expenses (5xxx)
      { code: '5000', name: 'Cost of Goods Sold', type: AccountType.EXPENSE }, // Added 5000 based on usage in JournalService
      { code: '5100', name: 'Operating Expenses', type: AccountType.EXPENSE }, // Generalized or specific
      { code: '5200', name: 'Inventory Adjustment', type: AccountType.EXPENSE }, // Added for stock adjustment
